...
<!--            </a>-->
            <p><i class="fa fa-copyright mt-4" aria-hidden="true"></i> by RHDevelopment</p>
        </div>
        <div class="pt-4">
            ...
            <label><input type="button" value="Subscribe" class="subscribe-text button mt-4 rounded-lg px-2 text-[#022f46]" margin-top="1rem"></label>
        </div>
</div>
<script>
